  ...
  setup: function() {
    ...
    adapter = DS.RESTAdapter.create({
      ...
      error: function( jqXhr, textStatus, errorThrown, emberParams ) {
        ...
        userErrorHandlerModels = emberParams.records;
      },
...
var expectUserErrorHandlerInvoked = function( action, records ) {
  var mockXhr = {};
  if( arguments.length < 2 ){ records = [person]; }
  ...
  deepEqual( userErrorHandlerModels, records, "User supplied error handlers are invoked on jQuery.ajax errors and passed records.");
};
